...
if not os.path.exists('status_processamento.csv') or len(cidades_para_executar) > 0:
    ...
    # all_city = all_city[all_city['Cidade'] == 'São Paulo - SP']
